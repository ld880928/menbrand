...
class BrandDetailViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let data_ = self.data {
            ...
            let addressString = data_.objectForKey("field_address") as? String
            htmlString = htmlString?.stringByReplacingOccurrencesOfString("addressString", withString: addressString!, options: NSStringCompareOptions.allZeros, range: nil)
